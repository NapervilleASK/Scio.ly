...
with open("beta_bank.json", 'a') as writefile:
    for folder_id in folder_links:
        ...
        pdf_files_in_folder = [f for f in all_files_in_folder if 'name' in f and not f['name'].lower().endswith('.pdf') and f['mimeType'] == 'application/pdf']
