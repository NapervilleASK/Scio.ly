...
titles = {
    ...
    'moons of solar system': 'Astronomy',
    'glue stick': 'Detector Building',
    'anatomy - blood types': 'Anatomy - Cardiovascular',
    'chemistry lab/physics': 'Chemistry Lab',
    'fill in the blanks': 'Codebusters',
    'scientific instruments': 'Physics Lab',
    'pipe cleaners': 'Detector Building',
    'joints matching': 'Anatomy - Skeletal',
    'thermodynamics/chemistry lab': 'Thermodynamics',
    'optics ray diagram': 'Optics',
    'cups': 'Experimental Design',
    'answer': 'Fermi Questions',
    'macroflora and fauna identification': 'Ecology',
    'units of measurement': 'Physics Lab',
    'geological time periods': 'Geologic Mapping',
    'michigan invasive species': 'Invasive Species',
    'optics short answer': 'Optics',
    'elastic launched glider': 'Flight',
    'geocaching': 'Geologic Mapping',
    'dynamic planet - earth and space': 'Dynamic Planet - Oceanography',
    'paper clips': 'Detector Building',
    'integumentary short answer': 'Anatomy - Integumentary',
    'general anatomy and physiology': 'Anatomy - Skeletal',
    'lymphatic - free response': 'Anatomy - Lymphatic',
    'physiology': 'Cell Biology',
    'weather events': 'Meteorology',
    'dynamic planet - oceanography - short answer': 'Dynamic Planet - Oceanography',
    'pennies': 'Chemistry Lab',
    'parts of human digestive system': 'Anatomy - Digestive',
    'anatomy - skeletal (bonus)': 'Anatomy - Skeletal',
    'materials science - polymers and plastics': 'Materials Science',
    'bowl': 'Chemistry Lab',
    'dynamic planet - oceanography - free response': 'Dynamic Planet - Oceanography',
    'simple machines': 'Machines',
    'parts of a cell': 'Cell Biology',
    'security notice': 'Cybersecurity',
    'unscramble the words': 'Codebusters',
    'anatomy & physiology': 'Anatomy - Skeletal',
    'game design': 'Game On',
    'post-it': 'Technical Problem Solving',
    'dynamic planet - general': 'Dynamic Planet - Oceanography',
    'axial skeleton labeling': 'Anatomy - Skeletal',
    'true or false': 'Scientific Reasoning',
    'muscle types': 'Anatomy - Muscular',
    'anatomy - diagrams': 'Anatomy - Skeletal',
    'anatomy - free response': 'Anatomy - Skeletal',
    'scientific reasoning': 'Scientific Reasoning',
    'materials science - general': 'Materials Science',
    'pencil': 'Technical Problem Solving',
    'paper': 'Technical Problem Solving',
    'long bone ranking': 'Anatomy - Skeletal',
    'materials science - generalmicrobe mission': 'Materials Science',
    'taxonomic ranks': 'Cell Biology',
    'elements on periodic table': 'Chemistry Lab',
    'chemistry lab calculation': 'Chemistry Lab',
    'potions and poisons free response': 'Potions and Poisons',
    'integumentary diagram': 'Anatomy - Integumentary',
    'anatomy - immune matching': 'Anatomy - Immune'
}
