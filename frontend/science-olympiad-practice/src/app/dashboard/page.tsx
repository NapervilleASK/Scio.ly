...
function EventDashboard() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-cyan-100 p-6 ">
        <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent mb-6">Test Generator Dashboard</h1>
        <div className="mb-6">
                ...
                <div>
                    ...
                    Question Types
                        ...
                        >
                            ...
                            <option value="medium">Free Response</option>
                            <option value="hard">Both</option>
                        </select>
                    </div>
                    <button className="w-full mt-6 px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg shadow-md hover:from-blue-600 hover:to-cyan-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-colors duration-200">
                        Generate Test
                    </button>
                </div>
            </div>
